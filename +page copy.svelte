...
>
	<div class="space-y-5 rounded-2xl p-5 outline-1 outline-slate-400 dark:outline-slate-600">
		<header class="flex justify-between">
			...
			<button
				type="button"
				class="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-slate-300 text-slate-800 dark:bg-slate-700 dark:text-slate-100"
			...
			>
				...
				<svg
					...
					><path d="M12 8a2.83 2.83 0 0 0 4 4 4 4 0 1 1-4-4" /><path d="M12 2v2" /><path
						d="M12 20v2"
					/><path d="m4.9 4.9 1.4 1.4" /><path d="m17.7 17.7 1.4 1.4" /><path d="M2 12h2" /><path
						d="M20 12h2"
					/><path d="m6.3 17.7-1.4 1.4" /><path d="m19.1 4.9-1.4 1.4" /></svg
				>
			</button>
		</header>
